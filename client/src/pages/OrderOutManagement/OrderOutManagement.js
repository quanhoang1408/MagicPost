...
import styles from './OrderOutManagement.module.scss';
import { useEffect, useRef, useState } from 'react';
import { Link } from 'react-router-dom';

import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faPenToSquare, faPrint, faTrash, faPlus, faHouse } from '@fortawesome/free-solid-svg-icons';
                                                        ...
                                                        <td>
                                                            <div className={cx('actions')}>
                                                                <Tippy 
                                                                    ...
                                                                    placement='bottom'
                                                                >
                                                                    <Button className={cx('actions-btn')} outline onClick={() => handleEdit(order.id)}>
                                                            ...
                                                            <div className={cx('actions')}>
                                                                <Tippy 
                                                                    ...
                                                                    placement='bottom'
                                                                >
                                                                    <Button className={cx('actions-btn')} outline onClick={handlePrint}>
...
export default OrderOutManagement;